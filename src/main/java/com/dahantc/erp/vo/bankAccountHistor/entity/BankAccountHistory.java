package com.dahantc.erp.vo.bankAccountHistor.entity;
...
@Entity
@Table(name = "erp_bank_account_history")
@DynamicUpdate(true)
public class BankAccountHistory implements Serializable {
	...
	@Id
	@Column(name = "bankaccounthistoryid", length = 32)
	@GeneratedValue(generator = "system-uuid")
	@GenericGenerator(name = "system-uuid", strategy = "uuid")
	private String bankAccountHistoryId;
	...
	public String getBankAccountHistoryId() {
		return bankAccountHistoryId;
	}

	public void setBankAccountHistoryId(String bankAccountHistoryId) {
		this.bankAccountHistoryId = bankAccountHistoryId;
	}
