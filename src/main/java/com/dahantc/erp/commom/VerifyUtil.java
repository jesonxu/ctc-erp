...
public class VerifyUtil {
	...
	public static final int MAX_FAIL_SIZE = 3;// 连续失败最大次数

	public static final long DISABLED_TIME = 10;// 连续失败禁用时间10分钟

	public static Map<String, UserInfo> userMap = new ConcurrentHashMap<String, UserInfo>();

	// 存放用户验证码
	public static Map<String, String> randomCodeMap = new HashMap<>();
	// 存放验证码有效时间
	...
	private static final char[] chars = { '2', '3', '4', '5', '6', '7', '8', '9', 'a', 'b', 'c', 'd', 'e', 'f', 'g', 'h', 'j', 'k', 'm', 'n', 'p', 'q', 'r',
			's', 't', 'u', 'v', 'w', 'x', 'y', 'z', 'A', 'B', 'C', 'D', 'E', 'F', 'G', 'H', 'J', 'K', 'L', 'M', 'N', 'P', 'Q', 'R', 'S', 'T', 'U', 'V', 'W',
			'X', 'Y', 'Z' };
	// 字符数量
