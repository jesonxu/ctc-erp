...
(function (layui, window, factory) {
	...
	Common.prototype.ajax = function (id, searchUrl, inputValue, isLinkage, linkageWidth, isSearch, successCallback, isReplace, asyncyType) {
		var _this5 = this;
		asyncyType !== undefined ? asyncyType : true;
	...
	Select4.prototype.data = function (id, type, config) {
		...
		if (type == 'local') {
			...
			common.ajax(id, config.url, config.keyword, config.linkage == true, config.linkageWidth ? config.linkageWidth : '100', '', '', '', false);
		}
		return this;
	};
