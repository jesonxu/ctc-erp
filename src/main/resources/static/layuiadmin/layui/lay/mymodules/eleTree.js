    ...
    Class.prototype={
        ...
        ajaxGetData: function() {
            ...
            $.ajax({
                ...
                ,success: function(res){
                    ...
                    if(res[options.response.dataName] != null && res[options.response.dataName].length > 0){
        ...
        rightClickMenu: function() {
            ...
            var menuStr=['<ul id="tree-menu">'
                ...
                ,$.inArray("add",options.contextmenuList)!==-1?'<li class="add"><a href="javascript:;">新增分组</a></li>'+
                    '<li class="insertAfter"><a href="javascript:;">插入同级分组</a></li>'+
                    '<li class="append"><a href="javascript:;">插入子分组</a></li>' : ""
                ,$.inArray("edit",options.contextmenuList)!==-1?'<li class="edit"><a href="javascript:;">修改分组名称</a></li>':''
                ,$.inArray("remove",options.contextmenuList)!==-1?'<li class="remove"><a href="javascript:;">删除分组</a></li>':''
            ,'</ul>'].join("");
