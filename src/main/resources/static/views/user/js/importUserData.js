 ...
 * 删除上传文件信息
 */
function delUploadFile(md5s){
    $.ajax({
        type: "POST",
        url: "/user/delUploadFile.action",
        dataType: "json",
        data: {
            md5s: md5s.join(",")
        },
...
function downloadTemplate() {
    window.location.href = "/views/user/user_data.xlsx";
}
